...
filter() //-->Retorna uma lista contando todos os elementos que passaram em um ste, ou seja, uma função escrita por nós

find()// --> Funciona de forma parecida com o filter, porém retorna apenas o imeiro valor que satisfizer o teste, podendo ser uma string ou um número.

findIndex() // --> Funciona igual o find(), mas retorna o índice em vez do emento, possibilitando usá-lo em outras partes do código.
